        ...
        <div id="content">
            ...
            <?php 
                ...
                <div class="col-md-12 col-sm-12 mb-2">
                    <label for="count">Place <span style="color:red">*</span></label>
                <textarea name="place" id="" class="form-control" required placeholder="Enter Here" cols="30" rows="7"></textarea>
                </div>
                <div class="col-md-6 col-sm-6 mb-2">
                    <label for="count">Number of Trees Planted <span style="color:red">*</span></label>
                <input type="text" name="count" class="form-control" required placeholder="Enter Here" autocomplete="off" id="count">
                </div>
                <div class="col-md-6 col-sm-6 mb-2">
